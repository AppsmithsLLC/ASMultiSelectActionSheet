...
extern void *mono_aot_module_ASMultiSelectActionSheet_Samples_info;
...
{
	mono_aot_register_module (mono_aot_module_ASMultiSelectActionSheet_Samples_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "ASMultiSelectActionSheet-Samples.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
